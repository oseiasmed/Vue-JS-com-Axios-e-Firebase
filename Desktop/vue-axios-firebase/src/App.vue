<template>
  <div id="app" class="container">
    <h1>Vue JS com Axios e Firebase</h1>
    <b-alert
      show
      dismissible
    ...
    <b-list-group>
      <b-list-group-item v-for="(usuario,id) in usuarios" :key="id">
        ...
        {{ usuario.email }}
        <br />
        <b-button variant="warning" size="lg" @click="alterar(id)" class="mt-2">Alterar</b-button>
        <b-button variant="danger" size="lg" @click="excluir(id)" class="ml-2 mt-2">Excluir</b-button>
      </b-list-group-item>
    </b-list-group>
  </div>
</template>
